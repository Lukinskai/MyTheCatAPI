...
modelToEndpointMap.set('images', '/images/search?limit=10&breed_ids=beng,abys,esho&');
// modelToEndpointMap.set('images', '/images/search?limit=30&');
modelToEndpointMap.set('breeds', '/breeds?');

const apiUrl = 'https://api.thecatapi.com/v1';
const apiKey = 'live_MyLymXXGPoDA6Df7x8M9paTQTu5DVI6v5nHoTSGC0SojLHxM4QIkrFI5EKy7ubYi';
